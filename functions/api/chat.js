...
# 我們解決的問題
臺灣傳統產業面臨「經驗斷層」危機。資深師傅退休、年輕人不願進入，數十年累積的工藝知識正在加速消失。「知識傳承」的前提是假的——傳承假設有人要接，但現實是接的人不會出現了。喬喜科技的答案是：不用傳了，讓 AI 直接幹。
...
2. Capture（捕捉）：Ontology 驅動 Scenario 自動生成，系統主動問老師傅問題，根據回答自動補洞。師傅是種子，AI 是放大器。
3. Deploy（部署）：AI Agent 上線，在真實業務場景中提供決策支援，從影子模式到正式接手，逐步建立信任。
...
2. 傳統製造業工廠：萃取老師傅的異常處理經驗，提供設備維護、品質追溯、製程優化建議
3. 基金會營運：建構調度決策的知識模型，POC 已完成初步驗證

# 定位與差異化
- 我們不是取代人想做的工作，是接住沒人要做的工作
- 競爭對手不是其他 AI 公司，是人力仲介跟外包顧問
- 定價邏輯：按省下那個找不到的人的成本來算
